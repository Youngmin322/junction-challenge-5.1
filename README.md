...
해류 시점 슬라이더를 움직이면 영역을 숨기지 않고, 해당 시점의 합성 해류 방향에 맞춰 전체 부채꼴이 회전합니다. 유속이 빠르면 길어지고 좁아지며, 느리면 짧고 넓어집니다. 진한 적색은 **부채꼴 중 취수구에 가까운 부분**이지 실제 막힘 확률이 아닙니다. 자세한 화면 의미와 실데이터 교체 위치는 [demo/README.md](./demo/README.md)에 있습니다.
